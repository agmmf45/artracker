...
(function () {
  ...
  const MUS_MAP = {
    ...
    'فخذ':     { target:'quads',                 bodyPart:'upper legs' },
    'خلفي الفخذ':{ target:'hamstrings',          bodyPart:'upper legs' },
    'ساق':     { target:'calves',                bodyPart:'lower legs' },
    'سمانة':   { target:'calves',                bodyPart:'lower legs' },
    'بطن':     { target:'abs',                   bodyPart:'waist' },
    'ساعد':    { target:'forearms',              bodyPart:'lower arms' },
    'ترابس':   { target:'traps',                 bodyPart:'back' },
  ...
  const REC = {
    ...
    'lower legs': { rest:'24–48 ساعة', vol:'12–20 جلسة/أسبوع',
                    tips:['السمانة تتحمّل تكراراً عالياً وتمديداً يومياً',
                          'توقّف لحظة في أعلى الحركة لانقباض أقوى',
                          'نوّع بين الواقف والجالس لاستهداف الرأسين'] },
